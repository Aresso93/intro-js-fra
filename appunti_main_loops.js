...
while (true) {
    ...
    if (input === 'FINE') {
        ...
        console.log(input.length); // ci da la lunghezza della stringa
    }
}
...
do { // vogliamo che venga eseguita ALMENO una volta - serve per fare i controlli
...
for (let index = 0; index < 10 index++) { // comprime tutto quello che abbiamo fatto con il ciclo while
...
const paperone = 'stringa di prova' // numero della posizione del carattere
